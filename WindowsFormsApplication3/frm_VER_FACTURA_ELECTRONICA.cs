...
{
    public partial class frm_VER_FACTURA_ELECTRONICA : Form
    {
        public frm_VER_FACTURA_ELECTRONICA()
        {
            InitializeComponent();
        }

        private void frm_VER_FACTURA_ELECTRONICA_Load(object sender, EventArgs e)
        {
            ...
            this.SP_DATOS_DETALLE_FACTURA_DATASETTableAdapter.Fill(this.DataSet_FACTURA_ELECTRONICA.SP_DATOS_DETALLE_FACTURA_DATASET,3);
            ...
            this.SP_LISTA_PRODUCTOS_DETALLE_FACTURA_DATASETTableAdapter.Fill(this.DataSet_FACTURA_ELECTRONICA.SP_LISTA_PRODUCTOS_DETALLE_FACTURA_DATASET,3);
            ...
            this.SP_RESULTADOS_DETALLE_FACTURA_DATASETTableAdapter.Fill(this.DataSet_FACTURA_ELECTRONICA.SP_RESULTADOS_DETALLE_FACTURA_DATASET,3);
